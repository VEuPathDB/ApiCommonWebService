...
public class DnaStreamingMatchFinder extends StreamingMatchFinder {
  private static final int BUFFER_SIZE = 65536;
  private static final int MAX_MATCH_LENGTH = 1024;

  private static final Logger LOG = Logger.getLogger(DnaStreamingMatchFinder.class);

  public DnaStreamingMatchFinder(MotifConfig config) {
    super(config);
  }
