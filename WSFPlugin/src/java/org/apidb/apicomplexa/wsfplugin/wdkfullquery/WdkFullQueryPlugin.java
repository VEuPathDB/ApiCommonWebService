...
public class WdkFullQueryPlugin extends WsfPlugin {
	...
	try {
	    ...
	    logger.info(recordClassName + " Determined from QuerySet " + queryName[0]);
	    ...
	    //This Section will preform the Attribute query and return the full result for this Query

	    componentResults = fillAttributes(results, orderedColumns, recordClass);

	    //End Attribute Query Section

	    //componentResults = results2StringArray(results);
	    //componentResults = fullResults2StringArray(results, orderedColumns, recordClass);
    ...
    */
	...
	else if(querySet.contains("Snp")) rc = "SnpRecordClasses.SnpRecordClass";
	return rc;
    }
    ...
    private String[][] fullResults2StringArray(ResultList result, String[] oc, RecordClass rc)throws WdkModelException
    {
	Column[] cols = result.getColumns();
